...
e monitoramento de apirários e suas localizações. Registro e histórico
de inspeções técnicas e outras ocorrências de manutenção. 


## Commits

Esse projeto seguirá a convenção Conventional Commits visando mensagens claras 
e padronizadas para facil identificação futura.
